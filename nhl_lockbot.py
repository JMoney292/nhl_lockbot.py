...
def compute_win(row):
    ...
    return {
        "WinScore": winscore, "HomeWinProb": winprob_home,
        "ML_Pick": f"{ml_team} ML", "Spread_Pick": spread_pick,
    ...
    if uploaded is not None:
        try:
            ...
            if simple_csv:
                ...
                need = ["home","away","puckline_home","total","rating_home","rating_away","xgf60_home","xga60_home","xgf60_away","xga60_away",
